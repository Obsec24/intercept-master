    ...
    // TrustManagerImpl (Android > 7)
        ...
        try {
            ...
            ApiClient.checkTrustedRecursive.implementation = function(obj1, obj2, obj3 , obj4, obj5, objs6) {
                send('{"type": "TrustManagerImpl_enhanced","domain":"' + obj4 + '","event":"intercept","status":true}');
                var k = array_list.$new();
                return k;
            }
            send('{"type": "TrustManagerImpl_Enhanced","domain": "N/A","event":"setup","status":true}');
         } catch (err) {
            send('{"type":"TrustManagerImpl_Enhanced","domain": "N/A","event":"setup","status":false}');
         }
         ...
         try {
            ...
            send('{"type":"Android WebViewClient_enhanced","domain": "N/A","event":"setup","status":true}');
         } catch (err) {
            send('{"type":"Android WebViewClient_enhanced","domain": "N/A","event":"setup","status":false}');
         }
         ...
         try {
            ...
            Pinner.a.overload('java.lang.String', '[Ljava.lang.String;').implementation = function(a, b) {
                send('{"type": "Okhttp(ANDREA)","domain":"' + a + '","event":"intercept","status":true}');
                return this;
            }
            send('{"type": "Okhttp_enhanced","domain": "N/A","event":"setup","status":true}');
         } catch (err) {
             send('{"type": "Okhttp_enhanced","domain": "N/A", "event":"setup","status":false}');
         }
         ...
         //Okhttp3 (Andrea)
          try {
            ...
            CertificatePinner.check.overload('java.lang.String', 'java.util.List').implementation = function() {
                send('{"type": "Okhttp_enhanced","domain":"N/A","event":"intercept","status":true}');
            };
            send('{"type": "Okhttp_enhanced","domain":"N/A","event":"setup","status":true}');
        } catch (err) {
            send('{"type": "Okhttp_enhanced","domain": "N/A","event":"setup","status":false}');
        ...
        try {
	      ...
	      SSLContext.init.overload("[Ljavax.net.ssl.KeyManager;", "[Ljavax.net.ssl.TrustManager;", "java.security.SecureRandom").implementation = function(a,b,c) {
	         SSLContext.init.overload("[Ljavax.net.ssl.KeyManager;", "[Ljavax.net.ssl.TrustManager;", "java.security.SecureRandom").call(this, a, tmf.getTrustManagers(), c);
	        	send('{"type":"trustmanager_enhanced","domain": "N/A","event":"intercept","status":true}');
	      };
	      send('{"type":"trustmanager_enhanced","domain": "N/A","event":"setup","status":true}');
	    } catch (err) {
              send('{"type":"trustmanager_enhanced","domain": "N/A","event":"setup","status":false}');
        }
